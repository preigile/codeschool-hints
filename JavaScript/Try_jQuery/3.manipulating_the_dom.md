...
_Пояснение._
Когда мы вибираем button, одни и те же события происходят на всех кнопках. Чтобы исправить это, выберем ближайшего предка определённого класса, а button поместим непосредственно в сам обработчик событий  качестве аргумента.
