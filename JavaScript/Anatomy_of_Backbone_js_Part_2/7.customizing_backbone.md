...
_Решение._
Проделаем примерно теже действия, что и в предыдущем задании, только теперь в отношении к строковому массиву:
```javascript
App.Views.Appointment = Backbone.View.extend({
...
## 7.7 Синхронизация для локольного запоминающего устройства II
